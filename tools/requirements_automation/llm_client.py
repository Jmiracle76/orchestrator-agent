...
class LLMClient:
    ...
    def integrate_answers(
        ...
        prompt = build_integrate_answers_prompt(
            section_id, section_context, answered_questions,
            full_profile, output_format, prior_sections
        )
    ...
    def draft_section(
        ...
        prompt = build_draft_section_prompt(
            section_id, section_context, prior_sections,
            full_profile, output_format
        )
    ...
    def perform_review(
        ...
        prompt = build_review_prompt(
            gate_id, doc_type, section_contents,
            full_profile, validation_rules
        )
