...
class StructuralValidator:
    ...
    def _validate_open_questions_table(self) -> None:
        ...
        if table_span:
            ...
            if columns != OPEN_Q_COLUMNS:
                self.errors.append(
                    TableSchemaError(f"Expected columns {OPEN_Q_COLUMNS}, got {columns}")
                )
    ...
    def _repair_missing_open_questions_table(self) -> None:
        ...
        if subsection_exists and subsection_line_idx is not None:
            ...
            self.repairs_made.append(
                "inserted missing open_questions table in risks_open_issues section"
            )
        else:
            ...
            self.repairs_made.append(
                "inserted missing open_questions subsection and table in risks_open_issues section"
            )
