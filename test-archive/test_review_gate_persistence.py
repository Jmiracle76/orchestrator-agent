...
from requirements_automation.models import HandlerConfig, ReviewIssue, ReviewResult, WorkflowResult
...
class MockLLM:
    ...
    def perform_review(
        self, gate_id, doc_type, section_contents, llm_profile=None, validation_rules=None
    ):
        """Mock review that always passes with no issues."""
        return {"summary": "All sections look good", "issues": [], "patches": []}
...
def test_review_gate_skip_only_if_passed():
    ...
    class TrackingMockLLM:
        ...
        def perform_review(
            ...
            return {"summary": "All sections look good now", "issues": [], "patches": []}
